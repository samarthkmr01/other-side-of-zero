...
const curriculumData = [\
    ...
    \{\
        ...
        content: "<p>You know the counting numbers: 1, 2, 3... and you know 0. But what if 0 isn't the end? What if it's a doorway?</p><p>Numbers extend in <b>two</b> directions. A number with a minus sign (\uc0\u8722 ) is a <b>negative number</b>. It represents a value less than zero.</p><p><b>\u55357 \u56593  Key Insight:</b> Zero is special. It is <b>neither positive nor negative</b>. Think of 0 as the neutral boundary between both worlds.</p>",\
        assessment: \{\
            ...
            hints: [\
                ...
                "Positive numbers have a '+' sign, and negative numbers have a '\uc0\u8722 ' sign. Does 0 have a sign?",\
            ...
            remediation: "<b>Misconception Detected:</b> You treated zero as a positive or negative number. Remember, zero is the freezing point of water (0\'b0C). It is neither 'hot' (positive) nor 'cold' (negative). It is the exact boundary!"\
        \}\
    \},\
    \{\
        id: "1.2",\
        title: "1.2 The Vertical Number Line",\
        content: "<p>Welcome to <b>Bela's Building of Fun!</b></p><p>The ground floor is Floor 0. The elevator has two buttons: '+' to go up, and '\uc0\u8722 ' to go down.</p><ul><li><b>Going Up (+):</b> Floors above ground are positive (+2 goes to the Art Centre).</li><li><b>Going Down (\u8722 ):</b> Floors below ground are negative (\u8722 2 goes to the Video Games shop!).</li></ul>",\
        assessment: \{\
            ...
            options: [\
                ...
                \{ text: "\uc0\u8722 4", isCorrect: true, misconception: null \},\
                \{ text: "0", isCorrect: false, misconception: null \},\
                \{ text: "\uc0\u8722 3", isCorrect: false, misconception: null \}\
            ],\
            hints: [\
                "Are you going up above the ground, or down below the ground?",\
                "Going underground uses negative (\uc0\u8722 ) numbers.",\
                "You are starting at 0 and going down 4 floors.",\
                "Underground floors are negative. Moving down 4 floors from 0 takes you to Floor \uc0\u8722 4."\
            ],\
    ...
    \{\
        ...
        content: "<p>When we measure temperature in Celsius, 0\'b0C is where water turns into ice.</p><p>Anything above zero is warm. But in places like Leh in Ladakh, the temperature drops below freezing! <b>\uc0\u8722 4\'b0C</b> means it is 4 degrees colder than freezing.</p>",\
        assessment: \{\
            question: "The city was 5\'b0C in the evening. By midnight, it dropped by 8 degrees. What is the temperature at midnight?",\
            options: [\
                \{ text: "13\'b0C", isCorrect: false, misconception: "M4" \},\
                \{ text: "3\'b0C", isCorrect: false, misconception: null \},\
                \{ text: "\uc0\u8722 3\'b0C", isCorrect: true, misconception: null \},\
                \{ text: "\uc0\u8722 8\'b0C", isCorrect: false, misconception: null \}\
            ],\
            hints: [\
                ...
                "5 - 5 = 0. You still have 3 more degrees to drop. 0 - 3 = \uc0\u8722 3."\
            ],\
...
function loadConcept() \{\
    if (learnerModel.currentIndex >= curriculumData.length) \{\
        document.getElementById('learning-section').innerHTML = "<h2>\uc0\u55356 \u57225  Course Complete!</h2><p>You are a Master of the Negative Zone!</p>";\
...
function requestHint() \{\
    ...
    if (learnerModel.hintsUsedOnCurrent < current.assessment.hints.length) \{\
        hintBox.innerText = "\uc0\u55357 \u56481  Hint: " + current.assessment.hints[learnerModel.hintsUsedOnCurrent];\
